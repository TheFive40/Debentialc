        ...
        return SmartInventory.builder()
                ...
                .provider(new InventoryProvider() {
                    ...
                    public void init(Player player, InventoryContents contents) {
                        ...
                        contents.set(1, 3, ClickableItem.of(renameButton, e -> {
                            player.closeInventory();
                        ...
                        contents.set(1, 4, ClickableItem.of(loreButton, e -> {
                            player.closeInventory();
                        ...
                        statsMeta.setDisplayName(CC.translate("&a&lVer Stats"));
                        List<String> statsLore = new ArrayList<>();
                        statsLore.add(CC.translate("&7Bonificaciones:"));
                        ...
                        contents.set(1, 5, ClickableItem.of(statsButton, e -> {
                            openStatsMenu(itemId).open(player);
                        }));
                        ...
                        contents.set(1, 6, ClickableItem.of(effectsButton, e -> {
